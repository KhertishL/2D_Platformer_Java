            ...
            for (int j=0; j <line.length();j++){
                switch (line.charAt(j)){
                    ...
                    case '1':
                     ...
                     //add coin - value 2 
                    case '2':
//                    	String imagePath = "resources/images/13.png";
//                    	Image coinImage = new Image(imagePath);
//                    	Node coin = createEntity2(j * 60, i * 60, 30, 30, coinImage);
//                    	coins.add(coin);
                    	
                    	Node coin = createEntity2(j*60, i *60, 60, 60, Color.web("F0E072",1.0));
                    	coins.add(coin);
	...
	private Node createEntity2(int x, int y, int w, int h, Color color){
        Rectangle entity = new Rectangle(w, h);
        entity.setTranslateX(x);
        entity.setTranslateY(y);
        entity.setFill(color);
...
//	private Node createEntity2(int x, int y, int w, int h, Image image) {
