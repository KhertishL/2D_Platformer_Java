...
public class Game extends Application {
    ...
    private void initContent(){
        ...
        //player position 
        Image characterSamurai = new Image(getClass().getResource("/platformGame/GameCharacter.png").toExternalForm());
...
//        gameRoot.getChildren().add(playerView);
    ...
    private void winner_board() {
		...
		Button RestartButton = createButton("Play Again", Color.web("776D5A",1.0), Game.class);
