...
public class main extends Application {
    ...
    private void initContent(){
        ...
        hitPoint.setTextFill(Color.WHITE);
            ...
            for (int j=0; j <line.length();j++){
                switch (line.charAt(j)){
                    ...
                    case '2':
                        ...
                        Image healthOrb = new Image(getClass().getResource("/platformGame/HP.png").toExternalForm());
                    	Node pickup = createEntity3(j * 60, i * 60, 60, 60, healthOrb);
                    	pickups.add(pickup);
                    	break;
                    ...
                    case '3':                    	
                        ...
                        Timeline timeline = new Timeline(
                            new KeyFrame(Duration.seconds(0.5), e -> enemies.setTranslateX(enemies.getTranslateX() + 100)),
                            new KeyFrame(Duration.seconds(1), e -> enemies.setTranslateX(enemies.getTranslateX() - 100))
                        );
...
//        gameRoot.getChildren().add(playerView);
    ...
    private void Goal(){
		...
		Button advanceButton = createButton("Go", Color.web("361d1d",1.0), main.class);
    ...
    private void winner_board() {
		...
		Button RestartButton = createButton("Play Again", Color.web("776D5A",1.0), main.class);
        Button menuButton = createButton("Menu", Color.web("A09CB0",1.0), StartScreen.class);
        Button quitButton = createButton("Quit", Color.web("987D7C",1.0), null);
